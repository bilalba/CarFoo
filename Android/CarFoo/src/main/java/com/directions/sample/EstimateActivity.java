...
public class EstimateActivity extends AppCompatActivity implements RoutingListener, GoogleApiClient.OnConnectionFailedListener, GoogleApiClient.ConnectionCallbacks {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.estimate_act);
